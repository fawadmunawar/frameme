...
import main1 from "../../assets/Sunglasses/main1.png";
import main2 from "../../assets/Sunglasses/main2.png";
import main3 from "../../assets/Sunglasses/main3.png";
import main4 from "../../assets/Sunglasses/main4.png";
import main5 from "../../assets/Sunglasses/main5.png";
import main6 from "../../assets/Sunglasses/main6.png";
import main7 from "../../assets/Sunglasses/main7.png";
import main8 from "../../assets/Sunglasses/main8.png";
...
const Sunglasses = () => {
  const products = [
    { name: "Aviator", price: 500, src: main1 },
    { name: "WayFarer", price: 700, src: main2 },
    { name: "Retro Squared", price: 800, src: main3 },
    { name: "Persol", price: 900, src: main4 },
    { name: "BrowLine", price: 500, src: main5 },
    { name: "Geometric", price: 600, src: main6 },
    { name: "Cat-Eye", price: 1000, src: main7 },
    { name: "Rounded", price: 600, src: main8 },
  ];
          ...
          <main className="md:w-3/4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {products.map((product, index) => (
              ...
              >
                ...
                <button className="mt-2 text-sm border p-1 rounded-lg hover:border-white hover:bg-black hover:text-white transition ">
                  Try on
                </button>
              </div>
            ))}
