...
import imagOne from "../../assets/Sunglasses/sunglasses.png";
import Header from "../Header/Header";

// --- MOCK DATA (Remote Images to ensure rendering) ---
const HERO_IMG = "https://images.unsplash.com/photo-1511499767150-a48a237f0083?auto=format&fit=crop&q=80&w=1000";

const PRODUCTS = [
  { id: 1, name: "Aviator Classic", price: 500, src: imagOne, tag: "Best Seller", rating: 4.8 },
  { id: 2, name: "Wayfarer Elite", price: 700, src: "https://images.unsplash.com/photo-1577803645773-f96470509666?auto=format&fit=crop&q=80&w=600", tag: "New", rating: 5.0 },
  { id: 3, name: "Retro Squared", price: 800, src: "https://images.unsplash.com/photo-1511499767150-a48a237f0083?auto=format&fit=crop&q=80&w=600", tag: "", rating: 4.5 },
  { id: 4, name: "Persol Icon", price: 900, src: "https://images.unsplash.com/photo-1509695507497-903c140c435c?auto=format&fit=crop&q=80&w=600", tag: "Premium", rating: 4.9 },
  { id: 5, name: "BrowLine Master", price: 500, src: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?auto=format&fit=crop&q=80&w=600", tag: "Sale", rating: 4.2 },
  { id: 6, name: "Geometric X", price: 600, src: "https://images.unsplash.com/photo-1591076482161-42ce6da69f67?auto=format&fit=crop&q=80&w=600", tag: "Trending", rating: 4.7 },
  { id: 7, name: "Cat-Eye Vogue", price: 1000, src: "https://images.unsplash.com/photo-1563903530908-afdd155d057a?auto=format&fit=crop&q=80&w=600", tag: "", rating: 4.6 },
  { id: 8, name: "Rounded Metal", price: 600, src: "https://images.unsplash.com/photo-1505934547515-fb27b738e4df?auto=format&fit=crop&q=80&w=600", tag: "", rating: 4.3 },
];
...
//         <p>Summer Sale: Up to 50% Off Selected Styles</p>
  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 w-full bg-[#f8f9fa] rounded-2xl flex items-center justify-center mb-4 overflow-hidden">
        {/* Blob Background */}
        <div className="absolute w-32 h-32 bg-orange-200/20 rounded-full blur-2xl group-hover:bg-orange-300/30 transition-colors duration-500"></div>
      ...
      <div className="px-2">
        ...
        <p className="text-sm text-gray-500 mb-4">Luxury Frames</p>
...
const Sunglasses = () => {
  const navigate = useNavigate();
  const [activeCategory, setActiveCategory] = useState("Sunglasses");
    ...
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative bg-[#0b0c10] text-white pt-24 pb-32 px-6 overflow-hidden">
        ...
        <motion.div 
           ...
           className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-orange-600/20 to-purple-600/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4"
        />
        
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-12 md:mb-0">
                <motion.div initial={{opacity:0, y: 20}} animate={{opacity:1, y:0}} transition={{duration: 0.6}}>
                     <span className="text-orange-500 font-bold tracking-[0.2em] text-sm uppercase">Summer 2025</span>
                     <h1 className="text-5xl md:text-7xl font-black mt-4 mb-6 leading-[1.1]">
                        Sun-Kissed <br/> 
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500">Perfection</span>
                     </h1>
                     <p className="text-gray-400 text-lg max-w-md mb-8 leading-relaxed">
                        Discover the frames that define your style. Ultra-lightweight, premium materials, and 100% UV protection.
                     </p>
                     <div className="flex gap-4">
            ...
            >
                <motion.img 
                    ...
                    src={HERO_IMG} 
                    alt="Hero Shades" 
                    className="w-full max-w-lg object-contain drop-shadow-[0_25px_25px_rgba(255,255,255,0.1)]"
                />
            </motion.div>
        </div>
      </section>
